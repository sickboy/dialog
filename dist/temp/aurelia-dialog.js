...
var _dec, _class, _dec2, _class3, _class4, _temp, _dec3, _dec4, _class5, _dec5, _dec6, _class6, _dec7, _dec8, _class8, _desc, _value, _class9, _descriptor, _descriptor2, _class10, _temp2, _dec9, _dec10, _class11, _class12, _temp3, _class13, _temp4;
...
}(), _class10.inject = [DialogController], _temp2), (_descriptor = _applyDecoratedDescriptor(_class9.prototype, 'buttons', [_aureliaTemplating.bindable], {
  enumerable: true,
  initializer: function initializer() {
    return [];
  }
}), _descriptor2 = _applyDecoratedDescriptor(_class9.prototype, 'useDefaultButtons', [_aureliaTemplating.bindable], {
  enumerable: true,
  initializer: function initializer() {
    return false;
  }
})), _class9)) || _class8) || _class8);
var AiDialogHeader = exports.AiDialogHeader = (_dec9 = (0, _aureliaTemplating.customElement)('ai-dialog-header'), _dec10 = (0, _aureliaTemplating.inlineView)('\n  <template>\n    <button type="button" class="dialog-close" aria-label="Close" if.bind="!controller.settings.lock" click.trigger="controller.cancel()">\n      <span aria-hidden="true">&times;</span>\n    </button>\n\n    <div class="dialog-header-content">\n      <slot></slot>\n    </div>\n  </template>\n'), _dec9(_class11 = _dec10(_class11 = (_temp3 = _class12 = function AiDialogHeader(controller) {
  _classCallCheck(this, AiDialogHeader);

  this.controller = controller;
}, _class12.inject = [DialogController], _temp3)) || _class11) || _class11);
...
}(), _class13.inject = [_aureliaDependencyInjection.Container, _aureliaTemplating.CompositionEngine], _temp4);
